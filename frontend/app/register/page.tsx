  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    try {
      ...
      if (token) {
        ...
        if (!loginRes.ok) {
          throw new Error(loginData.detail || loginData.message || "Account created, but login failed.");
        }

        localStorage.setItem("lossq_token", loginData.access_token || loginData.token);
      }
