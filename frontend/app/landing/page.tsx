...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#030508] text-[#F0F4FF] overflow-x-hidden">
      <div
        id="cursor"
        className="hidden md:block fixed w-3 h-3 bg-blue-500 rounded-full pointer-events-none z-[9999] -translate-x-1/2 -translate-y-1/2 mix-blend-screen"
      />

      <div
        id="cursorRing"
        className="hidden md:block fixed w-9 h-9 border border-blue-400/50 rounded-full pointer-events-none z-[9998] -translate-x-1/2 -translate-y-1/2"
      />
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-8 md:px-12 py-5 flex items-center justify-between bg-black/70 backdrop-blur-xl border-b border-blue-500/10">
        ...
        <div className="hidden md:flex items-center gap-8 text-xs uppercase tracking-[0.2em] text-slate-400">
          ...
          <a
            href="/login"
            className="border border-blue-500 text-blue-400 px-5 py-2 rounded hover:bg-blue-600 hover:text-white"
          >
            Launch App
          </a>
        </div>
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-6 pt-32">
        ...
        <p className="text-slate-400 text-lg md:text-xl leading-8 max-w-2xl mt-8">
          LossQ helps brokers process loss runs, analyze claim severity,
          generate renewal memos, create carrier packets, and explain account
          risk faster.
        </p>
        ...
        <div className="flex flex-wrap gap-4 justify-center mt-10">
          <a
            href="/login"
            className="bg-blue-600 hover:bg-blue-700 px-8 py-4 rounded-lg font-bold shadow-[0_0_40px_rgba(0,120,255,0.35)]"
          >
            Launch Demo →
          </a>
          ...
          <a
            href="#how"
            className="border border-white/15 hover:border-blue-500 hover:bg-blue-500/10 px-8 py-4 rounded-lg font-bold"
          >
            See How It Works
          </a>
        </div>
      ...
      >
        <p className="text-blue-400 text-xs tracking-[0.25em] uppercase mb-5">
          Platform Features
        </p>

        <h2 className="text-4xl md:text-6xl font-black max-w-3xl leading-tight">
          Everything an underwriter{" "}
          <span className="text-blue-500">actually</span> needs.
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px mt-16 bg-blue-500/15 border border-blue-500/15 rounded-2xl overflow-hidden">
          <Feature
            icon="⚡"
            title="Instant Loss Run Processing"
          ...
          <Feature
            icon="🧠"
            title="Claims Intelligence Panel"
            text="Clickable claim analysis with severity, reserve adequacy, litigation risk, and renewal impact."
            tag="// AI Claim Analysis"
          />

          <Feature
            icon="📊"
            title="Renewal Risk Scoring"
            text="Policy-specific summaries, trend analytics, reserve pressure, and underwriting risk indicators."
            tag="// Risk Engine"
          />

          <Feature
            icon="📋"
            title="Carrier Packet Generation"
            text="Generate carrier-ready PDFs, executive reports, and submission materials in one click."
            tag="// Submission Ready"
          />

          <Feature
            icon="✍️"
            title="Broker Narrative Generator"
            text="Create professional renewal memos and carrier narratives based on the selected policy."
            tag="// Memo Builder"
          />

          <Feature
            icon="🏢"
            title="Multi-Policy Workspaces"
            text="Separate business profiles, policy numbers, claims, charts, Copilot answers, and exports."
      ...
      <section
        id="how"
        className="relative z-10 px-6 py-28 bg-gradient-to-b from-transparent via-[#060D1A] to-transparent"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-16">
            <Step
              ...
              text="Drop in PDF, Excel, or CSV claim data."
            />

            <Step
              num="02"
              title="AI Parses Claims"
              text="LossQ extracts, normalizes, and organizes the claim information."
            />

            <Step
              num="03"
              title="Analyze Risk"
              text="See severity, litigation exposure, reserves, trends, and renewal risk."
            />

            <Step
              num="04"
              title="Export & Submit"
              text="Generate renewal memos, loss runs, and carrier-ready packets."
            />
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <Price
            tier="Starter"
            price="$99"
            desc="For solo brokers testing AI loss run workflows."
            features={[
              "1 user",
              "20 uploads/month",
          ...
          <Price
            ...
            tier="Pro"
            price="$249"
            desc="For agencies running active renewals and submissions."
            features={[
              "Up to 5 users",
              "Unlimited uploads",
              "Renewal memos",
          ...
          <Price
            tier="Agency"
            price="$499"
            desc="For larger teams needing full platform access."
            features={[
              "Unlimited users",
              "Unlimited uploads",
              "All Pro features",
        ...
        <div className="max-w-3xl mx-auto bg-[#0A1628] border border-blue-500/15 rounded-3xl p-10 md:p-20 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-slate-400 text-lg leading-8 mt-6">
              Join the beta and start turning messy loss runs into underwriting
              intelligence.
            </p>
      ...
      <footer className="relative z-10 border-t border-blue-500/15 px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-6 text-xs tracking-widest uppercase text-slate-500">
          ...
          <a href="mailto:hello@lossq.com" className="hover:text-white">
            Contact
          </a>
        </div>

        <p className="text-xs text-slate-500">
          © 2026 LossQ. All rights reserved.
        </p>
      </footer>
    </main>
  );
...
function Stat({
  ...
  return (
    <div className="p-7 border-b md:border-b-0 md:border-r border-blue-500/15 last:border-0">
      ...
      <div className="text-xs tracking-widest uppercase text-slate-500 mt-2">
        {label}
      </div>
    </div>
  );
...
function Feature({
  ...
  return (
    <div className="bg-[#060D1A] hover:bg-[#0A1628] p-9 transition">
      ...
      <p className="text-blue-400 font-mono text-xs tracking-widest mt-6">
        {tag}
      </p>
    </div>
  );
...
function Price({
  ...
  return (
    <div
      className={`relative bg-[#0A1628] border rounded-2xl p-9 ${
        featured
          ? "border-blue-500 shadow-[0_0_45px_rgba(0,120,255,0.25)]"
          : "border-blue-500/15"
      }`}
    >
      {featured && (
      ...
      <ul className="space-y-3 mb-9">
        {features.map((feature) => (
          <li
            key={feature}
            className="text-slate-400 text-sm border-b border-white/5 pb-3"
          >
      ...
      <a
        href="/login"
        className={`block text-center rounded-lg py-4 font-bold ${
          featured
            ? "bg-blue-600 hover:bg-blue-700"
            : "border border-white/15 hover:border-blue-500 hover:bg-blue-500/10"
        }`}
      >
        Get Started
      </a>
    ...
    <div className="relative z-10 overflow-hidden border-y border-blue-500/15 bg-[#060D1A] py-4">
      <div className="flex gap-16 whitespace-nowrap animate-[ticker_24s_linear_infinite]">
        {[...items, ...items].map((item, index) => (
          <span
            key={`${item}-${index}`}
            className="text-slate-500 text-xs tracking-[0.25em] uppercase shrink-0"
          >
            <span className="text-blue-400 mr-2">→</span>
            {item}
          </span>
