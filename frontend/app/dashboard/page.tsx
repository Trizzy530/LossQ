...
const LOSSQ_DASHBOARD_LANGUAGE_TEXT: Record<string, Record<string, string>> = {
 ...
 german: {
  overview: "Übersicht",
  profiles: "Versichererprofile",
  upload: "Upload-Center",
  exposureInputs: "Expositionsdaten",
  submissionBuilder: "Einreichung erstellen",
  renewalRisk: "Verlängerungsrisiko",
  premiumForecast: "Prämienprognose",
  decision: "Underwriter-Entscheidung",
  carrierAppetite: "Versichererappetit",
  submissionReadiness: "Einreichungsbereitschaft",
  carrierMatch: "Versichererabgleich",
  summary: "KI-Zusammenfassung",
  memo: "Verlängerungsnotiz",
  charts: "Diagramme",
  claims: "Schäden",
  totalClaims: "Schäden gesamt",
  openClaims: "Offene Schäden",
  totalIncurred: "Gesamtaufwand",
  riskLevel: "Risikostufe",
  renewalProbability: "Verlängerungswahrscheinlichkeit",
  marketContext: "Marktkontext",
  outputLanguage: "Ausgabesprache",
  reviewLanguage: "Sprache ändern",
  dashboardIntro: "Wählen Sie ein Werkzeug aus der Seitenleiste, um Schäden, Verlängerungsrisiko, Underwriting-Entscheidungen, Berichte und Versichererstrategie zu analysieren.",
 },
 italian: {
  overview: "Panoramica",
  profiles: "Profili compagnie",
  upload: "Centro caricamento",
  exposureInputs: "Dati di esposizione",
  submissionBuilder: "Creazione proposta",
  renewalRisk: "Rischio rinnovo",
  premiumForecast: "Previsione premio",
  decision: "Decisione underwriting",
  carrierAppetite: "Appetito compagnia",
  submissionReadiness: "Prontezza proposta",
  carrierMatch: "Abbinamento compagnie",
  summary: "Riepilogo IA",
  memo: "Memo rinnovo",
  charts: "Grafici",
  claims: "Sinistri",
  totalClaims: "Sinistri totali",
  openClaims: "Sinistri aperti",
  totalIncurred: "Totale sostenuto",
  riskLevel: "Livello di rischio",
  renewalProbability: "Probabilità di rinnovo",
  marketContext: "Contesto di mercato",
  outputLanguage: "Lingua output",
  reviewLanguage: "Cambia lingua",
  dashboardIntro: "Seleziona uno strumento dalla barra laterale per analizzare sinistri, rischio di rinnovo, decisioni underwriting, report e strategia delle compagnie.",
 },
 dutch: {
  overview: "Overzicht",
  profiles: "Verzekeraarprofielen",
  upload: "Uploadcentrum",
  exposureInputs: "Blootstellingsgegevens",
  submissionBuilder: "Indiening maken",
  renewalRisk: "Verlengingsrisico",
  premiumForecast: "Premieprognose",
  decision: "Underwriterbesluit",
  carrierAppetite: "Verzekeraarsappetite",
  submissionReadiness: "Indieningsgereedheid",
  carrierMatch: "Verzekeraarsmatch",
  summary: "AI-samenvatting",
  memo: "Verlengingsmemo",
  charts: "Grafieken",
  claims: "Claims",
  totalClaims: "Totaal claims",
  openClaims: "Open claims",
  totalIncurred: "Totaal geleden",
  riskLevel: "Risiconiveau",
  renewalProbability: "Verlengingskans",
  marketContext: "Marktcontext",
  outputLanguage: "Uitvoertaal",
  reviewLanguage: "Taal wijzigen",
  dashboardIntro: "Selecteer een hulpmiddel in de zijbalk om claims, verlengingsrisico, underwritingbesluiten, rapporten en verzekeraarsstrategie te analyseren.",
 },
 arabic: {
  overview: "نظرة عامة",
  profiles: "ملفات شركات التأمين",
  upload: "مركز الرفع",
  exposureInputs: "مدخلات التعرض",
  submissionBuilder: "منشئ التقديم",
  renewalRisk: "مخاطر التجديد",
  premiumForecast: "توقع القسط",
  decision: "قرار المكتتب",
  carrierAppetite: "شهية شركة التأمين",
  submissionReadiness: "جاهزية التقديم",
  carrierMatch: "مطابقة شركات التأمين",
  ...
  totalIncurred: "إجمالي المتكبد",
  riskLevel: "مستوى المخاطر",
  renewalProbability: "احتمال التجديد",
  marketContext: "سياق السوق",
  outputLanguage: "لغة الإخراج",
  reviewLanguage: "تغيير اللغة",
  dashboardIntro: "اختر أداة من الشريط الجانبي لتحليل المطالبات ومخاطر التجديد وقرارات الاكتتاب والتقارير واستراتيجية شركات التأمين.",
 },
 chinese: {
  overview: "概览",
  profiles: "保险公司档案",
  upload: "上传中心",
  exposureInputs: "风险暴露输入",
  submissionBuilder: "提交生成器",
  renewalRisk: "续保风险",
  premiumForecast: "保费预测",
  decision: "核保决定",
  carrierAppetite: "保险公司承保偏好",
  submissionReadiness: "提交准备度",
  carrierMatch: "保险公司匹配",
  summary: "AI 摘要",
  memo: "续保备忘录",
  charts: "图表",
  ...
  totalIncurred: "总发生额",
  riskLevel: "风险等级",
  renewalProbability: "续保概率",
  marketContext: "市场背景",
  outputLanguage: "输出语言",
  reviewLanguage: "更改语言",
  dashboardIntro: "从侧边栏选择工具，以分析理赔、续保风险、核保决定、报告和保险公司策略。",
 },
 japanese: {
  overview: "概要",
  profiles: "保険会社プロファイル",
  upload: "アップロードセンター",
  exposureInputs: "エクスポージャー入力",
  submissionBuilder: "提出書類ビルダー",
  renewalRisk: "更新リスク",
  premiumForecast: "保険料予測",
  decision: "アンダーライター判断",
  carrierAppetite: "保険会社の引受意欲",
  submissionReadiness: "提出準備度",
  carrierMatch: "保険会社マッチ",
  summary: "AI要約",
  memo: "更新メモ",
  charts: "チャート",
  claims: "保険金請求",
  ...
  totalIncurred: "総発生額",
  riskLevel: "リスクレベル",
  renewalProbability: "更新確率",
  marketContext: "市場コンテキスト",
  outputLanguage: "出力言語",
  reviewLanguage: "言語を変更",
  dashboardIntro: "サイドバーからツールを選択して、請求、更新リスク、引受判断、レポート、保険会社戦略を分析します。",
 },
 korean: {
  overview: "개요",
  profiles: "보험사 프로필",
  upload: "업로드 센터",
  exposureInputs: "노출 정보 입력",
  submissionBuilder: "제출 자료 작성",
  renewalRisk: "갱신 위험",
  premiumForecast: "보험료 예측",
  decision: "언더라이터 결정",
  carrierAppetite: "보험사 인수 성향",
  submissionReadiness: "제출 준비도",
  carrierMatch: "보험사 매칭",
  summary: "AI 요약",
  memo: "갱신 메모",
  charts: "차트",
  ...
  totalClaims: "총 클레임",
  openClaims: "미결 클레임",
  totalIncurred: "총 발생 손해액",
  riskLevel: "위험 수준",
  renewalProbability: "갱신 가능성",
  marketContext: "시장 맥락",
  outputLanguage: "출력 언어",
  reviewLanguage: "언어 변경",
  dashboardIntro: "사이드바에서 도구를 선택해 클레임, 갱신 위험, 언더라이팅 결정, 보고서, 보험사 전략을 분석하세요.",
 },
 hindi: {
  overview: "अवलोकन",
  profiles: "बीमा कंपनी प्रोफाइल",
  upload: "अपलोड केंद्र",
  exposureInputs: "एक्सपोजर इनपुट",
  submissionBuilder: "सबमिशन बिल्डर",
  renewalRisk: "नवीनीकरण जोखिम",
  premiumForecast: "प्रीमियम पूर्वानुमान",
  decision: "अंडरराइटर निर्णय",
  carrierAppetite: "बीमा कंपनी रुचि",
  submissionReadiness: "सबमिशन तैयारी",
  carrierMatch: "बीमा कंपनी मिलान",
  summary: "AI सारांश",
  memo: "नवीनीकरण मेमो",
  charts: "चार्ट",
  claims: "दावे",
  ...
  totalIncurred: "कुल खर्च",
  riskLevel: "जोखिम स्तर",
  renewalProbability: "नवीनीकरण संभावना",
  marketContext: "बाजार संदर्भ",
  outputLanguage: "आउटपुट भाषा",
  reviewLanguage: "भाषा बदलें",
  dashboardIntro: "दावों, नवीनीकरण जोखिम, अंडरराइटिंग निर्णयों, रिपोर्ट और बीमा रणनीति का विश्लेषण करने के लिए साइडबार से टूल चुनें.",
 },
 punjabi: {
  overview: "ਸੰਖੇਪ",
  profiles: "ਬੀਮਾ ਕੰਪਨੀ ਪ੍ਰੋਫਾਈਲਾਂ",
  upload: "ਅਪਲੋਡ ਕੇਂਦਰ",
  exposureInputs: "ਐਕਸਪੋਜ਼ਰ ਇਨਪੁੱਟ",
  submissionBuilder: "ਸਬਮਿਸ਼ਨ ਬਿਲਡਰ",
  renewalRisk: "ਨਵੀਨੀਕਰਨ ਜੋਖਮ",
  premiumForecast: "ਪ੍ਰੀਮੀਅਮ ਅਨੁਮਾਨ",
  decision: "ਅੰਡਰਰਾਈਟਰ ਫੈਸਲਾ",
  carrierAppetite: "ਬੀਮਾ ਕੰਪਨੀ ਰੁਚੀ",
  submissionReadiness: "ਸਬਮਿਸ਼ਨ ਤਿਆਰੀ",
  carrierMatch: "ਬੀਮਾ ਕੰਪਨੀ ਮਿਲਾਣ",
  summary: "AI ਸੰਖੇਪ",
  memo: "ਨਵੀਨੀਕਰਨ ਮੈਮੋ",
  charts: "ਚਾਰਟ",
  claims: "ਦਾਅਵੇ",
  totalClaims: "ਕੁੱਲ ਦਾਅਵੇ",
  openClaims: "ਖੁੱਲ੍ਹੇ ਦਾਅਵੇ",
  totalIncurred: "ਕੁੱਲ ਖਰਚ",
  riskLevel: "ਜੋਖਮ ਪੱਧਰ",
  renewalProbability: "ਨਵੀਨੀਕਰਨ ਸੰਭਾਵਨਾ",
  marketContext: "ਬਾਜ਼ਾਰ ਸੰਦਰਭ",
  outputLanguage: "ਆਉਟਪੁੱਟ ਭਾਸ਼ਾ",
  reviewLanguage: "ਭਾਸ਼ਾ ਬਦਲੋ",
  dashboardIntro: "ਦਾਅਵੇ, ਨਵੀਨੀਕਰਨ ਜੋਖਮ, ਅੰਡਰਰਾਈਟਿੰਗ ਫੈਸਲੇ, ਰਿਪੋਰਟਾਂ ਅਤੇ ਬੀਮਾ ਰਣਨੀਤੀ ਦਾ ਵਿਸ਼ਲੇਸ਼ਣ ਕਰਨ ਲਈ ਸਾਈਡਬਾਰ ਤੋਂ ਟੂਲ ਚੁਣੋ.",
 },
 urdu: {
  overview: "جائزہ",
  profiles: "انشورنس کمپنی پروفائلز",
  upload: "اپ لوڈ مرکز",
  exposureInputs: "ایکسپوژر معلومات",
  submissionBuilder: "سبمیشن بلڈر",
  renewalRisk: "تجدید کا خطرہ",
  premiumForecast: "پریمیم پیش گوئی",
  decision: "انڈر رائٹر فیصلہ",
  carrierAppetite: "انشورنس کمپنی کی دلچسپی",
  submissionReadiness: "سبمیشن تیاری",
  carrierMatch: "انشورنس کمپنی میچ",
  summary: "AI خلاصہ",
  memo: "تجدید میمو",
  charts: "چارٹس",
  claims: "کلیمز",
  totalClaims: "کل کلیمز",
  openClaims: "کھلے کلیمز",
  totalIncurred: "کل خرچ",
  riskLevel: "خطرے کی سطح",
  renewalProbability: "تجدید کا امکان",
  marketContext: "مارکیٹ سیاق",
  outputLanguage: "آؤٹ پٹ زبان",
  reviewLanguage: "زبان تبدیل کریں",
  dashboardIntro: "کلیمز، تجدید کے خطرے، انڈر رائٹنگ فیصلوں، رپورٹس اور انشورنس حکمت عملی کا تجزیہ کرنے کے لیے سائیڈ بار سے ٹول منتخب کریں.",
 },
 vietnamese: {
  overview: "Tổng quan",
  profiles: "Hồ sơ hãng bảo hiểm",
  upload: "Trung tâm tải lên",
  exposureInputs: "Dữ liệu phơi nhiễm",
  submissionBuilder: "Tạo hồ sơ gửi",
  renewalRisk: "Rủi ro tái tục",
  premiumForecast: "Dự báo phí",
  decision: "Quyết định thẩm định",
  carrierAppetite: "Khẩu vị hãng bảo hiểm",
  submissionReadiness: "Mức sẵn sàng hồ sơ",
  carrierMatch: "Ghép hãng bảo hiểm",
  summary: "Tóm tắt AI",
  memo: "Ghi nhớ tái tục",
  charts: "Biểu đồ",
  claims: "Bồi thường",
  totalClaims: "Tổng bồi thường",
  openClaims: "Bồi thường mở",
  totalIncurred: "Tổng phát sinh",
  riskLevel: "Mức rủi ro",
  renewalProbability: "Xác suất tái tục",
  marketContext: "Bối cảnh thị trường",
  outputLanguage: "Ngôn ngữ đầu ra",
  reviewLanguage: "Đổi ngôn ngữ",
  dashboardIntro: "Chọn một công cụ từ thanh bên để phân tích bồi thường, rủi ro tái tục, quyết định thẩm định, báo cáo và chiến lược hãng bảo hiểm.",
 },
 tagalog: {
  overview: "Pangkalahatan",
  profiles: "Mga Profile ng Carrier",
  upload: "Upload Center",
  exposureInputs: "Mga Exposure Input",
  submissionBuilder: "Submission Builder",
  renewalRisk: "Panganib sa Renewal",
  premiumForecast: "Premium Forecast",
  decision: "Desisyon ng Underwriter",
  carrierAppetite: "Carrier Appetite",
  submissionReadiness: "Kahandaan ng Submission",
  carrierMatch: "Carrier Match",
  summary: "AI Summary",
  memo: "Renewal Memo",
  charts: "Mga Chart",
  claims: "Mga Claim",
  totalClaims: "Kabuuang Claim",
  openClaims: "Bukas na Claim",
  totalIncurred: "Kabuuang Incurred",
  riskLevel: "Antas ng Panganib",
  renewalProbability: "Posibilidad ng Renewal",
  marketContext: "Konteksto ng Market",
  outputLanguage: "Wika ng Output",
  reviewLanguage: "Palitan ang Wika",
  dashboardIntro: "Pumili ng tool sa sidebar upang suriin ang claims, renewal risk, underwriting decisions, reports, at carrier strategy.",
 },
 polish: {
  overview: "Przegląd",
  profiles: "Profile ubezpieczycieli",
  upload: "Centrum przesyłania",
  exposureInputs: "Dane ekspozycji",
  submissionBuilder: "Kreator zgłoszenia",
  renewalRisk: "Ryzyko odnowienia",
  premiumForecast: "Prognoza składki",
  decision: "Decyzja underwritera",
  carrierAppetite: "Apetyt ubezpieczyciela",
  submissionReadiness: "Gotowość zgłoszenia",
  carrierMatch: "Dopasowanie ubezpieczycieli",
  summary: "Podsumowanie AI",
  memo: "Memo odnowienia",
  charts: "Wykresy",
  claims: "Roszczenia",
  totalClaims: "Łącznie roszczeń",
  openClaims: "Otwarte roszczenia",
  totalIncurred: "Łączna szkoda",
  riskLevel: "Poziom ryzyka",
  renewalProbability: "Prawdopodobieństwo odnowienia",
  marketContext: "Kontekst rynku",
  outputLanguage: "Język wyjściowy",
  reviewLanguage: "Zmień język",
  dashboardIntro: "Wybierz narzędzie z paska bocznego, aby analizować roszczenia, ryzyko odnowienia, decyzje underwritingowe, raporty i strategię ubezpieczycieli.",
 },
 russian: {
  overview: "Обзор",
  profiles: "Профили страховщиков",
  upload: "Центр загрузки",
  exposureInputs: "Данные экспозиции",
  submissionBuilder: "Конструктор заявки",
  renewalRisk: "Риск продления",
  premiumForecast: "Прогноз премии",
  decision: "Решение андеррайтера",
  carrierAppetite: "Аппетит страховщика",
  submissionReadiness: "Готовность заявки",
  carrierMatch: "Подбор страховщика",
  summary: "AI-сводка",
  memo: "Мемо продления",
  charts: "Графики",
  claims: "Убытки",
  totalClaims: "Всего убытков",
  openClaims: "Открытые убытки",
  totalIncurred: "Общий ущерб",
  riskLevel: "Уровень риска",
  renewalProbability: "Вероятность продления",
  marketContext: "Рыночный контекст",
  outputLanguage: "Язык вывода",
  reviewLanguage: "Изменить язык",
  dashboardIntro: "Выберите инструмент на боковой панели для анализа убытков, риска продления, андеррайтинговых решений, отчетов и стратегии страховщиков.",
 },
 ukrainian: {
  overview: "Огляд",
  profiles: "Профілі страховиків",
  upload: "Центр завантаження",
  exposureInputs: "Дані експозиції",
  submissionBuilder: "Конструктор подання",
  renewalRisk: "Ризик поновлення",
  premiumForecast: "Прогноз премії",
  decision: "Рішення андеррайтера",
  carrierAppetite: "Апетит страховика",
  submissionReadiness: "Готовність подання",
  carrierMatch: "Підбір страховика",
  summary: "AI-підсумок",
  memo: "Мемо поновлення",
  charts: "Графіки",
  claims: "Збитки",
  totalClaims: "Усього збитків",
  openClaims: "Відкриті збитки",
  totalIncurred: "Загальна сума",
  riskLevel: "Рівень ризику",
  renewalProbability: "Ймовірність поновлення",
  marketContext: "Ринковий контекст",
  outputLanguage: "Мова виводу",
  reviewLanguage: "Змінити мову",
  dashboardIntro: "Виберіть інструмент на бічній панелі, щоб аналізувати збитки, ризик поновлення, рішення андеррайтингу, звіти та стратегію страховиків.",
 },
 greek: {
  overview: "Επισκόπηση",
  profiles: "Προφίλ ασφαλιστών",
  upload: "Κέντρο μεταφόρτωσης",
  exposureInputs: "Στοιχεία έκθεσης",
  submissionBuilder: "Δημιουργία υποβολής",
  renewalRisk: "Κίνδυνος ανανέωσης",
  premiumForecast: "Πρόβλεψη ασφαλίστρου",
  decision: "Απόφαση underwriter",
  carrierAppetite: "Διάθεση ασφαλιστή",
  submissionReadiness: "Ετοιμότητα υποβολής",
  carrierMatch: "Αντιστοίχιση ασφαλιστών",
  summary: "Σύνοψη AI",
  memo: "Σημείωμα ανανέωσης",
  charts: "Γραφήματα",
  claims: "Απαιτήσεις",
  totalClaims: "Σύνολο απαιτήσεων",
  openClaims: "Ανοικτές απαιτήσεις",
  totalIncurred: "Σύνολο ζημιών",
  riskLevel: "Επίπεδο κινδύνου",
  renewalProbability: "Πιθανότητα ανανέωσης",
  marketContext: "Πλαίσιο αγοράς",
  outputLanguage: "Γλώσσα εξόδου",
  reviewLanguage: "Αλλαγή γλώσσας",
  dashboardIntro: "Επιλέξτε εργαλείο από την πλευρική γραμμή για ανάλυση απαιτήσεων, κινδύνου ανανέωσης, αποφάσεων underwriting, αναφορών και στρατηγικής ασφαλιστών.",
 },
 turkish: {
  overview: "Genel Bakış",
  profiles: "Sigortacı Profilleri",
  upload: "Yükleme Merkezi",
  exposureInputs: "Risk Maruziyeti Girdileri",
  submissionBuilder: "Başvuru Oluşturucu",
  renewalRisk: "Yenileme Riski",
  premiumForecast: "Prim Tahmini",
  decision: "Underwriter Kararı",
  carrierAppetite: "Sigortacı İştahı",
  submissionReadiness: "Başvuru Hazırlığı",
  carrierMatch: "Sigortacı Eşleştirme",
  summary: "AI Özeti",
  memo: "Yenileme Notu",
  charts: "Grafikler",
  claims: "Hasarlar",
  totalClaims: "Toplam Hasar",
  openClaims: "Açık Hasarlar",
  totalIncurred: "Toplam Gerçekleşen",
  riskLevel: "Risk Seviyesi",
  renewalProbability: "Yenileme Olasılığı",
  marketContext: "Pazar Bağlamı",
  outputLanguage: "Çıktı Dili",
  reviewLanguage: "Dili Değiştir",
  dashboardIntro: "Hasarları, yenileme riskini, underwriting kararlarını, raporları ve sigortacı stratejisini analiz etmek için kenar çubuğundan bir araç seçin.",
 },
 hebrew: {
  overview: "סקירה",
  profiles: "פרופילי מבטחים",
  upload: "מרכז העלאה",
  exposureInputs: "נתוני חשיפה",
  submissionBuilder: "בניית הגשה",
  renewalRisk: "סיכון חידוש",
  premiumForecast: "תחזית פרמיה",
  decision: "החלטת חתם",
  carrierAppetite: "תיאבון מבטח",
  submissionReadiness: "מוכנות הגשה",
  carrierMatch: "התאמת מבטחים",
  summary: "סיכום AI",
  memo: "מזכר חידוש",
  charts: "תרשימים",
  claims: "תביעות",
  totalClaims: "סה״כ תביעות",
  openClaims: "תביעות פתוחות",
  totalIncurred: "סה״כ נזק",
  riskLevel: "רמת סיכון",
  renewalProbability: "הסתברות חידוש",
  marketContext: "הקשר שוק",
  outputLanguage: "שפת פלט",
  reviewLanguage: "שנה שפה",
  dashboardIntro: "בחר כלי בסרגל הצד כדי לנתח תביעות, סיכון חידוש, החלטות חיתום, דוחות ואסטרטגיית מבטחים.",
 },
 swahili: {
  overview: "Muhtasari",
  profiles: "Wasifu wa Bima",
  upload: "Kituo cha Kupakia",
  exposureInputs: "Taarifa za Hatari",
  submissionBuilder: "Muundaji wa Uwasilishaji",
  renewalRisk: "Hatari ya Upyaishaji",
  premiumForecast: "Utabiri wa Ada",
  decision: "Uamuzi wa Underwriter",
  carrierAppetite: "Nia ya Kampuni ya Bima",
  submissionReadiness: "Utayari wa Uwasilishaji",
  carrierMatch: "Ulinganishaji wa Bima",
  summary: "Muhtasari wa AI",
  memo: "Memo ya Upyaishaji",
  charts: "Chati",
  claims: "Madai",
  totalClaims: "Jumla ya Madai",
  openClaims: "Madai Yaliyo Wazi",
  totalIncurred: "Jumla Iliyotokea",
  riskLevel: "Kiwango cha Hatari",
  renewalProbability: "Uwezekano wa Upyaishaji",
  marketContext: "Muktadha wa Soko",
  outputLanguage: "Lugha ya Matokeo",
  reviewLanguage: "Badilisha Lugha",
  dashboardIntro: "Chagua zana kutoka kwenye upau wa pembeni ili kuchambua madai, hatari ya upyaishaji, maamuzi ya underwriting, ripoti na mkakati wa bima.",
 },
 portuguese: {
...
// LOSSQ_RENEWAL_RISK_INSURED_QUESTIONS_V3
function lossqQuestionsToAskInsured(profileLike: any, claimsLike: any[] = [], policiesLike: any[] = []) {
 ...
 const profileText = normalizeText([
  ...
  profileLike?.operations,
  profileLike?.scope_of_work,
  profileLike?.business_operations,
  profileLike?.class_code,
  profileLike?.class_codes,
  profileLike?.naics,
  profileLike?.sic,
 ...
 const policyText = normalizeText(
  safePolicies
   .map((policy: any) =>
    [
     policy?.line_of_business,
 ...
 const exposureText = normalizeText([
  profileLike?.vehicle_count,
  profileLike?.driver_count,
  profileLike?.employee_count,
  profileLike?.location_count,
  profileLike?.payroll,
  profileLike?.revenue,
  profileLike?.exposure_basis,
 ].join(" "));

 const businessScopeText = `${profileText} ${policyText} ${claimText}`;
 const primaryText = `${profileText} ${policyText}`;

 const hasAny = (source: string, patterns: string[]) =>
 ...
 const categoryScore = (patterns: string[]) => {
  let score = 0;

  patterns.forEach((pattern) => {
   if (profileText.includes(pattern)) score += 4;
   if (policyText.includes(pattern)) score += 2;
   if (claimText.includes(pattern)) score += 1;
  });
 ...
 const orderedCategories = Object.entries(scores).sort((a: any, b: any) => b[1] - a[1]);
 const primaryCategory = orderedCategories[0]?.[1] > 0 ? orderedCategories[0][0] : "general";

 const openClaims = safeClaims.filter((claim: any) => isOpenClaimStatus(claim));

 const hasWorkersComp =
  hasAny(policyText, ["workers compensation", "workers comp", " wc "]) ||
  hasAny(claimText, ["workers compensation", "workers comp", "employee injury", "injury"]);

 const hasProperty =
  primaryCategory === "property" ||
  hasAny(policyText, ["property", "bop", "building"]) ||
  hasAny(claimText, ["fire", "water damage", "theft", "property"]);

 const hasPremises =
  hasAny(businessScopeText, ["general liability", "premises", "slip", "fall", "trip", "visitor", "customer"]);

 const hasAutoLine =
  hasAny(policyText, ["commercial auto", "business auto", "auto liability", "fleet"]) ||
  hasAny(claimText, ["commercial auto", "auto liability", "vehicle accident"]);

 const hasMaterialAutoOperations =
  primaryCategory === "transportation" ||
  hasAny(profileText, ["courier", "delivery", "trucking", "transportation", "motor carrier", "fleet", "ambulance", "patient transport"]);

 const hasCargoOperations =
  primaryCategory === "transportation" ||
  hasAny(policyText, ["motor truck cargo", "cargo"]) ||
  hasAny(profileText, ["cargo", "freight", "warehouse", "logistics", "delivery"]);
 ...
 if (primaryCategory === "healthcare") {
  addQuestion("Were patient safety, resident safety, supervision, staffing, or incident-response procedures updated after the reported losses?");
  addQuestion("Are patient fall-prevention procedures, transfer protocols, rounding logs, and incident reports documented?");
  addQuestion("Have medication handling, charting, infection-control, or care-plan review procedures changed since the loss period?");
  addQuestion("Are employee credentials, training records, background checks, and abuse/neglect prevention controls current?");
  addQuestion("Are staffing levels, employee duties, patient volume, or service lines changing for the upcoming renewal term?");
 }

 if (primaryCategory === "barRestaurant") {
 ...
 if (primaryCategory === "construction") {
  ...
  addQuestion("Are written contracts, hold-harmless agreements, and additional-insured requirements used consistently?");
 }

 if (primaryCategory === "transportation") {
 ...
 if (primaryCategory === "salon") {
  ...
  addQuestion("Are independent booth renters or subcontracted providers used, and are agreements or certificates maintained?");
 }

 if (primaryCategory === "property") {
  ...
  addQuestion("Are sidewalks, parking areas, entrances, lighting, and common areas inspected regularly?");
 }

 if (primaryCategory === "professional") {
  addQuestion("Are contracts, scopes of work, client sign-offs, quality review, and documentation procedures current?");
  addQuestion("Have complaint handling, file documentation, peer review, or client communication procedures changed since the reported incident?");
 }

 if (primaryCategory === "cyber") {
  ...
  addQuestion("Have data access controls, vendor controls, privacy procedures, or backup testing changed since the reported event?");
 }

 if (hasWorkersComp && primaryCategory !== "healthcare") {
 ...
 if (hasWorkersComp && primaryCategory === "healthcare") {
  addQuestion("Were return-to-work procedures and employee injury-prevention steps updated for clinical and non-clinical staff?");
 }

 if (hasPremises && !["barRestaurant", "healthcare", "property"].includes(primaryCategory)) {
  addQuestion("Does the insured have written premises inspection, incident reporting, and customer or visitor safety procedures?");
 }

 if (hasProperty && !["property", "barRestaurant", "healthcare"].includes(primaryCategory)) {
  addQuestion("Have property protection, maintenance, security, fire prevention, or water-damage controls changed since the reported losses?");
 }

 // Only ask MVR/driver questions when auto is truly part of the account's operations.
 // This prevents a hospital, bar, salon, or property account from receiving transportation questions
 // just because stale claim text or incidental wording contains vehicle-related terms.
 if (hasAutoLine && hasMaterialAutoOperations && primaryCategory !== "healthcare") {
  addQuestion("Have driver screening, MVR review, vehicle maintenance, or accident-prevention procedures changed since the reported auto losses?");
 }

 if (hasAutoLine && hasMaterialAutoOperations && primaryCategory === "healthcare") {
  addQuestion("If the insured operates ambulances, shuttles, or patient transport vehicles, are driver qualification, maintenance, and incident-reporting procedures documented?");
 }

 if (hasCargoOperations && primaryCategory === "transportation") {
 ...
 addQuestion("Are there any changes in payroll, revenue, employee count, locations, services, or operations for the upcoming renewal term?");
      ...
      <>
       ...
       {(() => {
        ...
        const marketDateFormat =
         ...
         (isCanadaMarket ? "YYYY/DD/MM" : "MM/DD/YYYY");
  ...
  return (
   <section className="glass-panel p-6 md:p-8">
    ...
    <div className="mb-8 rounded-3xl border border-blue-400/30 bg-blue-500/10 p-5">
     <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
      <div>
       ...
       <p className="mt-2 text-sm leading-6 text-slate-300">
        {hasPremiumData
         ? `Premium forecast updated using uploaded Exposure Inputs.`
    ...
    <ListCard
     ...
     color="blue"
     items={[
      "Uploaded Exposure Inputs included in forecast.",
    ...
    <div className="mt-6">
     <TextCard
      ...
      text={
       hasPremiumData
        ? "Premium forecast updated using uploaded Exposure Inputs."
        : "Add current premium in the uploaded file or Exposure Inputs to generate a premium forecast."
      }
     />
    </div>
   </section>
