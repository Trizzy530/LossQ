        ...
        claims.append(
            {
                ...
                "claim_type": line,
                "effective_date": clean_text(get_from_row(row_values, header_map, "effective_date", "")) or policy_dates.get("effective_date", ""),
                "expiration_date": clean_text(get_from_row(row_values, header_map, "expiration_date", "")) or policy_dates.get("expiration_date", ""),
