...
def claim_to_dict(claim: Claim):
    return {
        ...
        "jurisdiction_state": clean_value(getattr(claim, "jurisdiction_state", "") or getattr(claim, "venue_state", "")),
        "jurisdiction": clean_value(getattr(claim, "jurisdiction_state", "") or getattr(claim, "venue_state", "")),
        "state": clean_value(getattr(claim, "jurisdiction_state", "") or getattr(claim, "venue_state", "")),
        "adjuster": clean_value(getattr(claim, "adjuster", "") or getattr(claim, "examiner", "")),
        "adjuster_examiner": clean_value(getattr(claim, "adjuster", "") or getattr(claim, "examiner", "")),
        "examiner": clean_value(getattr(claim, "examiner", "") or getattr(claim, "adjuster", "")),
