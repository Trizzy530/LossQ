...
def ensure_account_profile_columns(db: Session):
    required_columns = {
        ...
        "current_premium": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "expiring_premium": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "target_renewal_premium": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "line_of_business": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "state": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "class_code": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "class_codes": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "limits": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "coverage_limit": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "deductible": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "retention": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "payroll": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "revenue": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "sales": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "receipts": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "employee_count": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "vehicle_count": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "driver_count": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "property_tiv": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "tiv": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "building_value": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "contents_value": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "square_footage": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "location_count": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "unit_count": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "cargo_limit": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "umbrella_limit": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "experience_mod": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "mod": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "exposure_change_percent": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "cyber_revenue": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "professional_revenue": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "exposure_basis": "TEXT" if field == "underwriter_notes" else "VARCHAR",
        "underwriter_notes": "TEXT" if field == "underwriter_notes" else "VARCHAR",
    }
